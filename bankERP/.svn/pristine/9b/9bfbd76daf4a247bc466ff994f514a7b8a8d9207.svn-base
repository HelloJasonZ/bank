			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            新柜员注册 <small>Registered Teller</small>
                        </h1>
                    </div>
                </div>
                                  ...
                                  <h4>登录信息</h4>
                                    <form>
                                         <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" placeholder="用户名称" name="tName">
                                        </div> 
                                        ...
                                        <div class="form-group has-success">
										 ...
										 <div class="form-group has-success">
                                            ...
                                            <input type="password" class="form-control" id="inputSuccess" placeholder="确认密码/Confirm Password" name="tPassword_1" maxlength="18">
                                        </div>
