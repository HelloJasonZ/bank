        ...
        <div class="cd-user-modal"> 
			...
			<div id="cd-login">
				<form class="cd-form">
					<p class="fieldset">
						<label >工号</label>
						<input class="full-width has-padding has-border" id="teller_no" type="text" rea>
					</p>
					
					<p class="fieldset">
						<label >姓名</label>
						<input class="full-width has-padding has-border" id="teller_name" type="text">
					</p>
					...
					<input class="full-width has-padding has-border" type="submit" value="更改">
	 			</form>
			</div>
