                  	 ...
                  	 <li>
                        ...
                        <a  href="ui-elements.html"><i class="fa fa-desktop"></i>经理业务<span class="fa arrow"></span></a>
                            ...
                            <li>
                             ...
                             <li>
                               <a href="${ctx}/teller/returnShowAccountData.do"><i class="fa fa-bar-chart-o"></i>查看柜员绩效</a>
                            </li>
                       </ul>
                     </li>
                     </c:if>
    ...
    <script src="${ctx}/style/assets/js/custom-scripts.js"></script>
 	...
 	function checkPasswordAction(){
 		$ .ajax({
 			type: 'POST',
 			dateType: 'json',
 			url: '{ctx}/teller/updateTellerPassword',
 			error: function(data){
 				alert(data.status);
 			},
 			success: function(data){
 				if(data == "0"){
 					...
 					alert("修改密码成功");
 					window.location.href = '{ctx}/views/teller/update_teller_password.jsp';
 				}else{
 					alert("密码未成功修改");
 					window.location.href = '{ctx}/views/teller/update_teller_password.jsp';
 				}
