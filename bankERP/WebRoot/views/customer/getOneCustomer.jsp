        ...
        <table class="table table-striped table-bordered table-hover"
											style="text-align: center;">
												<tr align="center">
													...
													<th style="text-align: center;" colspan="6"> 操作</th>
												</tr>
												<tr align="center">
													...
													<td style="text-align: center;">${customer.cusIdCard }</td>
													<td style="text-align: center;">${customer.cusEmail }</td>
													<td style="text-align: center;">${customer.cusAddress }</td>
													<td style="text-align: center;"><c:if test="${customer.cusState==true}">正常</c:if><c:if test="${customer.cusState==false}">失效</c:if></td>
													<td style="text-align: center;"><fmt:formatDate
															value="${customer.cusCreateTime }" pattern="yyyy-MM-dd HH:mm:ss" /></td>
													<td style="text-align: center;"><fmt:formatDate
															value="${customer.cusLoginTime }" pattern="yyyy-MM-dd HH:mm:ss" /></td> 
													<td style="text-align: center;">${customer.tId }</td>
													<td colspan="3" >
														<%-- <a href="${ctx}/customer/get_customer.do?cusId=${customer.cusId}">修改信息</a> --%>
														<a href="${ctx}/customer/getCustomerState.do?cusId=${customer.cusId}">修改信息</a>
													</td> 
													<%-- <td colspan="3">
														<a href="${ctx}/customer/getCustomerState.do?cusId=${customer.cusId}">修改状态</a>
													</td>  --%>
												</tr>
										</table>
        </div>
