								...
								<div class="panel-body" style="text-align: center;">
									<div class="table-responsive">
										<div align="center">
											...
											<form action="${ctx}/transactions/listByDate.do" method="get">

												<div class="form-group input-group" style="width:100px;">
												<span class="input-group-btn">
															<input type="text" class="form-control"
																style="width:200px;" placeholder="身份证号" name="cus_idcard"
																value="${param.cus_idcard }"> 
														</span> &nbsp;&nbsp;&nbsp;&nbsp;
														<span class="input-group-btn">
															<input type="text" class="form-control"
																style="width:200px;" placeholder="账号" name="acNumber"
																value="${param.acNumber }"> 
														</span> &nbsp;&nbsp;&nbsp;&nbsp;
														<span class="input-group-btn"> 
															<input type="text"
